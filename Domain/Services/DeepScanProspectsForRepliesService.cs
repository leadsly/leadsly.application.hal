...
{
    public class DeepScanProspectsForRepliesService : IDeepScanProspectsForRepliesService
    {
        public DeepScanProspectsForRepliesService(ILogger<DeepScanProspectsForRepliesService> logger, IDeepScanProspectsForRepliesServiceApi serviceApi)
        {
            _logger = logger;
            _serviceApi = serviceApi;
        }

        private readonly ILogger<DeepScanProspectsForRepliesService> _logger;
        ...
        public async Task ProcessCampaignProspectsThatRepliedAsync(IList<ProspectReplied> prospects, DeepScanProspectsForRepliesBody message, CancellationToken ct = default)
        {
