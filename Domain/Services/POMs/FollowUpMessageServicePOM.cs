...
{
    public class FollowUpMessageServicePOM : IFollowUpMessageServicePOM
    {
        public FollowUpMessageServicePOM(
            ILogger<FollowUpMessageServicePOM> logger,
        ...
        private readonly ILogger<FollowUpMessageServicePOM> _logger;
