...
namespace Domain.Services.POMs
{
    ...
    {
        public SearchPageFooterService(IHumanBehaviorService humanBehaviorService, ISearchResultsFooter searchResultsFooter, ILinkedInSearchPage linkedInSearchPage, ILogger<SearchPageFooterService> logger)
        {
