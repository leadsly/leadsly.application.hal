...
{
    public class HowDoYouKnowModalServicePOM : IHowDoYouKnowModalServicePOM
    {
        public HowDoYouKnowModalServicePOM(ILogger<HowDoYouKnowModalServicePOM> logger, IHumanBehaviorService humanBehaviorService, IHowDoYouKnowDialog dialog)
        {
            _logger = logger;
        ...
        private readonly ILogger<HowDoYouKnowModalServicePOM> _logger;
