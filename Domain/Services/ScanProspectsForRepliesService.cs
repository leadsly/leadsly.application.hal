...
{
    public class ScanProspectsForRepliesService : IScanProspectsForRepliesService
    {
        public ScanProspectsForRepliesService(ILogger<ScanProspectsForRepliesService> logger, IScanProspectsForRepliesServiceApi scanProspectsForRepliesServiceApi)
        {
            _logger = logger;
            _scanProspectsForRepliesServiceApi = scanProspectsForRepliesServiceApi;
        }

        private readonly ILogger<ScanProspectsForRepliesService> _logger;
