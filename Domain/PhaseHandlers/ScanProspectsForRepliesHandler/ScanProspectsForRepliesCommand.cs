...
namespace Domain.PhaseHandlers.ScanProspectsForRepliesHandler
{
    ...
    {
        public ScanProspectsForRepliesCommand(IModel channel, BasicDeliverEventArgs eventArgs, PublishMessageBody messageBody, string startOfWorkDay, string endOfWorkDay, string timezoneId)
        {
            Channel = channel;
            EventArgs = eventArgs;
