...
namespace Domain.PhaseHandlers.NetworkingHandler
{
    ...
    {
        public NetworkingCommand(IModel channel, BasicDeliverEventArgs eventArgs, PublishMessageBody messageBody, string startOfWorkDay, string endOfWorkDay, string timezoneId)
        {
            Channel = channel;
            EventArgs = eventArgs;
